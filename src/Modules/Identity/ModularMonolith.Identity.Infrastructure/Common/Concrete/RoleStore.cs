...
{
    private readonly IIdentityDatabase _identityDbContext;
    private readonly IdentityErrorDescriber _identityErrorDescriber;

    public RoleStore(IIdentityDatabase identityDbContext, IdentityErrorDescriber identityErrorDescriber)
    {
