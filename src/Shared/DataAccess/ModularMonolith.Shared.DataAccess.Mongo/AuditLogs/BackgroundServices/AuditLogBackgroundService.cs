...
public class AuditLogBackgroundService : BackgroundService
{
    ...
    public AuditLogBackgroundService(IMongoDatabase mongoDatabase, IOptionsMonitor<AuditLogOptions> optionsMonitor, TimeProvider timeProvider)
    {
