...
using ModularMonolith.Shared.DataAccess.EntityFramework.Cosmos.AuditLogs.Factories;
...
namespace ModularMonolith.Shared.DataAccess.EntityFramework.Cosmos.AuditLogs.Stores;
