...
using ModularMonolith.Shared.DataAccess.EntityFramework.Cosmos.EventLogs.Factories;
...
namespace ModularMonolith.Shared.DataAccess.EntityFramework.Cosmos.EventLogs.Stores;
