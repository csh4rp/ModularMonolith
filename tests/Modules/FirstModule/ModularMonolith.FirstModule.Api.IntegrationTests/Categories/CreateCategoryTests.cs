...
public class CreateCategoryTests : BaseIntegrationTest<CreateCategoryTests, Program>
{
    ...
    {
        // Arrange
        _postgresFixture.FirstModuleDbContext.Categories.Add(new Category { Id = Guid.NewGuid(), Name = "Category-2" });
        await _postgresFixture.FirstModuleDbContext.SaveChangesAsync();
