...
DECLARE new_user_name CONSTANT VARCHAR(128) := 'mail@mail.com';
DECLARE new_user_password_hash CONSTANT VARCHAR(255) := 'AQAAAAIAAYagAAAAEMbO4U0+72DTJTrynS9mX+9SokWZbBi9opL+zLvvgauBIWs6QRwDpUFPaHdEe6e+Mw==';

BEGIN

IF NOT EXISTS (SELECT 1 FROM "identity"."user" WHERE user_name = new_user_name) THEN
